...
newsClassif <- head(newsDataQuant, 10000) # current classification set we're using for all classification problems (change to newsDataBinary for binary classification or newsDataTrinary for three-way classification)
...
newsClassif <- head(newsDataBinary, 10000) # current classification set we're using for all classification problems (change to newsDataBinary for binary classification or newsDataTrinary for three-way classification)
...
newsClassif <- head(newsDataTrinary, 10000) # current classification set we're using for all classification problems (change to newsDataBinary for binary classification or newsDataTrinary for three-way classification)
